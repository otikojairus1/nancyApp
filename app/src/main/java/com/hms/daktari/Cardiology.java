...
public class Cardiology extends AppCompatActivity implements ItemClickListener  {

    CardiologyAdapter adapter;
    String Globalname;
    String GlobalEmail;
    String GlobalDept;
...
//            window.setStatusBarColor(Color.TRANSPARENT);
        ...
        Cursor cursor = db.rawQuery(selectQuery, new String[]{"Cardiology"});
        // Move to first row
        cursor.moveToFirst();
        ...
        //end
        RecyclerView recyclerView = findViewById(R.id.sdkjajgaAS6);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter = new CardiologyAdapter(this, CardiologyList);
